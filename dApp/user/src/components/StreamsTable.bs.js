                          ...
                          className: "shadow overflow-hidden border border-black rounded"
                              ...
                              className: "min-w-full divide-y divide-gray-200"
                                  ...
                                  className: "bg-white divide-y divide-black"
                                          ...
                                          className: "px-2 py-4 whitespace-nowrap text-sm text-gray-800 w-full"
                                        }, React.createElement("div", {
                                              className: "relative pt-1 "
                                                  ...
                                                  className: "flex items-center overflow-hidden h-7 mb-2 text-xs text-white justify-between bg-gray-500"
                                                    ...
                                                    }, React.createElement("p", undefined, "8th Apr 21")), React.createElement("div", {
                                                      className: "px-2"
                                                    }, React.createElement("p", undefined, "7th Apr 22"))))), React.createElement("td", {
                                          className: "px-5 py-0 whitespace-nowrap text-sm text-gray-500"
                                        }, React.createElement("div", {
                                              className: ""
                                          ...
                                          className: "px-2 py-4 whitespace-nowrap text-sm text-gray-500 w-full"
                                              ...
                                              className: "relative pt-1 "
                                                  ...
                                                  className: "flex items-center overflow-hidden h-7 mb-2 text-xs text-white justify-between bg-gray-500"
                                                    ...
                                                    }, React.createElement("p", undefined, "1st Feb 21")), React.createElement("div", {
                                                      className: "px-2"
                                                    }, React.createElement("p", undefined, "2nd Feb 21"))))), React.createElement("td", {
                                          className: "px-5 py-0 whitespace-nowrap text-sm text-gray-500"
                                        }, React.createElement("div", {
                                              className: ""
                                            }, React.createElement("input", {
